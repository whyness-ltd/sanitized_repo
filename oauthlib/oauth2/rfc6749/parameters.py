...
def prepare_grant_uri(uri, client_id, response_type, redirect_uri=None,
    ...
    .. _`W3C.REC-html401-19991224`: https://REMOVED
...
def prepare_token_revocation_request(url, token, token_type_hint="access_token",
    ...
    .. _`Section 1.4`: https://REMOVED
    .. _`Section 1.5`: https://REMOVED
    .. _`Section 4.1.2`: https://REMOVED
...
def parse_token_response(body, scope=None):
    ...
    .. _`Section 6`: https://REMOVED
    .. _`Section 3.3`: https://REMOVED
    .. _`RFC4627`: https://REMOVED
    """
    try:
