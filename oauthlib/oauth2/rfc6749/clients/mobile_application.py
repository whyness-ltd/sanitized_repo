...
class MobileApplicationClient(Client):
    ...
    def prepare_request_uri(self, uri, redirect_uri=None, scope=None,
        ...
        argument, set to ``token``::
            ...
            'https://REMOVED?client_id=your_id&response_type=token'
            >>> client.prepare_request_uri('https://REMOVED', redirect_uri='https://a.b/callback')
            'https://REMOVED?client_id=your_id&response_type=token&redirect_uri=https%3A%2F%2Fa.b%2Fcallback'
            >>> client.prepare_request_uri('https://REMOVED', scope=['profile', 'pictures'])
            'https://REMOVED?client_id=your_id&response_type=token&scope=profile+pictures'
            >>> client.prepare_request_uri('https://REMOVED', foo='bar')
            'https://REMOVED?client_id=your_id&response_type=token&foo=bar'
