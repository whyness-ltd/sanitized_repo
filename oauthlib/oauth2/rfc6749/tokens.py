...
def prepare_mac_header(token, uri, key, http_method,
    ...
    .. _`MAC Access Authentication`: https://REMOVED
    .. _`extension algorithms`: https://REMOVED
    ...
    # hmac struggles with unicode strings - https://REMOVED
...
class BearerToken(TokenBase):
    ...
    def create_token(self, request, refresh_token=False, **kwargs):
        ...
        # If provided, include - this is optional in some cases https://REMOVED but
