...
.. _`OAuth 2.0 Authorization Server Metadata`: https://REMOVED
"""
import copy
import json
import logging
...
class MetadataEndpoint(BaseEndpoint):
   ...
   .. _`OpenID Connect Discovery 1.0`: https://REMOVED
   .. _`RFC7591`: https://REMOVED
   """
    ...
    def validate_metadata_server(self):
       ...
       Discovery 1.0 [`OpenID.Discovery`_].
        ...
        .. _`RFC8414 section 2`: https://REMOVED
        .. _`RFC6749#Authorization`: https://REMOVED
        .. _`RFC6749#Token`: https://REMOVED
        .. _`RFC7591`: https://REMOVED
        .. _`OpenID.Discovery`: https://REMOVED
        """
