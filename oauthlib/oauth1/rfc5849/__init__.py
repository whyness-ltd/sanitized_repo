...
class Client:
    ...
    def get_oauth_signature(self, request):
        ...
        To satisfy `section IP.REMOVED`_ item 2, if the request argument's
    ...
    def get_oauth_params(self, request):
        ...
        # Note that SHA-1 is vulnerable. The spec acknowledges that in https://REMOVED
    ...
    def sign(self, uri, http_method='GET', body=None, headers=None, realm=None):
        ...
        # IP.REMOVED.1.  Parameter Sources
